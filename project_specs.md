...
- **Assessments:** each curriculum section (1–4) has a dedicated three-part section test at `/test/section/N` (match words, missing word, conversation). Book 1 has a final test in the same shape at `/test/final`. Content lives in `content/book1/assessments/`.
