# YouTube pipeline — How to Speak Bosnian in 30 Days
...
5. Upload to playlist **How to Speak Bosnian in 30 Days — Book 1** with link to `/learn/day/N` and image credits in the description.
